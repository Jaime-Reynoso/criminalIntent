...
public class CrimeListFragment extends ListFragment {
    ...
    public void onCreateOptionsMenu(Menu item, MenuInflater inflater)
    {
    	...
    	inflater.inflate(R.menu.fragment_crime_list, item);
    	
    	MenuItem showSubtitle = item.findItem(R.id.menu_item_show_subtitle);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState){
    	...
    	/*
    	 * This registers the long press as a contextual thing
    	 */
